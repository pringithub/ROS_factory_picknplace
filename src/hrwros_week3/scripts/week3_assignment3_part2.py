...
if __name__ == '__main__':
    ...
    turtlebot_robot1_goal.target_pose.pose.position.x = -8.1 #<Add-second-goal-Position-X>
    turtlebot_robot1_goal.target_pose.pose.position.y = -1.43 #<Add-second-goal-Position-Y>
