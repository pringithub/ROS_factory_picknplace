...
if __name__ == '__main__':
    ...
    turtlebot_robot1_goal.target_pose.pose.position.x = 0.13 #<Add-first-goal-Position-X>
    turtlebot_robot1_goal.target_pose.pose.position.y = 1.44 #<Add-first-goal-Position-Y>
