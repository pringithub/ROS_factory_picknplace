	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Move R1 Home',
										...
										transitions={'reached': 'Start Conveyer Belt', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
			...
			OperatableStateMachine.add('Stop feeder',
										...
										transitions={'succeeded': 'Stop Conveyer Belt', 'failed': 'failed'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:213 y:44
			OperatableStateMachine.add('Start Conveyer Belt',
			...
			# x:896 y:53
			OperatableStateMachine.add('Stop Conveyer Belt',
			...
			# x:547 y:646
			OperatableStateMachine.add('Move turtlebot to R2',
										hrwros_factory_states__MoveBaseState(),
			...
			# x:50 y:555
			OperatableStateMachine.add('Pick from turtlebot',
										...
										transitions={'reached': 'Move R2 to Home', 'planning_failed': 'failed', 'control_failed': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off},
			...
			OperatableStateMachine.add('Activate Gripper 2',
										...
										transitions={'continue': 'Pick from turtlebot', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off})

			# x:23 y:353
			OperatableStateMachine.add('Move R2 above bin',
			...
			OperatableStateMachine.add('Detect Part Camera2',
										...
										transitions={'continue': 'Compute Pick R2', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'pose': 'part_pose'})

			# x:267 y:639
			OperatableStateMachine.add('Compute Pick R2',
										ComputeGraspState(group=pick2_group, offset=0, joint_names=names2, tool_link=gripper2, rotation=3.14),
			...
			OperatableStateMachine.add('Move R2 Home',
										flexbe_manipulation_states__SrdfStateToMoveit(config_name="R2Home", move_group=pick2_group, action_topic='/move_group', robot_name=""),
										transitions={'reached': 'Move turtlebot to R2', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
										remapping={'config_name': 'config_name', 'move_group': 'move_group', 'robot_name': 'robot_name', 'action_topic': 'action_topic', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
			...
			OperatableStateMachine.add('Move R2 to Home',
										...
										transitions={'reached': 'Move R2 above bin', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
										remapping={'config_name': 'config_name', 'move_group': 'move_group', 'robot_name': 'robot_name', 'action_topic': 'action_topic', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
